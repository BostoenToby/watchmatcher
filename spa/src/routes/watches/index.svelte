  ...
  <section class="grid grid-cols-4 gap-16 m-20 font-text">
    {#each watches as watch}
      <div
        ...
        <div class="flex justify-between">
          ...
          <Link
            to="/watches/{watch.type.replaceAll(' ', '-').toLocaleLowerCase()}"
    ...
    <!-- <div
      ...
      <div class="aspect-square flex overflow-hidden justify-center rounded-md">
        <img
          src="/watches/rolex-OYSTER-PERPETUAL.webp"
          alt=""
          class="max-h-full" />
      </div>
      <div class="flex justify-between">
    ...
    <div
      ...
      <div class="aspect-square flex overflow-hidden justify-center rounded-md">
        <img
          src="/watches/audemars-piguet-CODE-11,59.png"
          alt=""
          class="max-h-full" />
      </div>
      <div class="flex justify-between">
    ...
    <div
      ...
      <div class="aspect-square flex overflow-hidden justify-center rounded-md">
        <img
          src="/watches/audemars-piguet-ROYAL-OAK.png"
          alt=""
          class="max-h-full" />
      </div>
      <div class="flex justify-between">
    ...
    <div
      ...
      <div class="aspect-square flex overflow-hidden justify-center rounded-md">
        <img
          src="/watches/hublot-INTEGRATED-KING-GOLD-CERAMIC.png"
          alt=""
          class="max-h-full" />
      </div>
      <div class="flex justify-between">
    ...
    <div
      ...
      <div class="aspect-square flex overflow-hidden justify-center rounded-md">
        <img
          src="/watches/vacheron-constantin-FIFTYSIX-TOURBILLON.webp"
          alt=""
          class="max-h-full" />
      </div>
      <div class="flex justify-between">
